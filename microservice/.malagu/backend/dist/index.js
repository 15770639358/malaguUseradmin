...
function applyAutowiredDecorator(option, target, targetKey, index, doInject, doGetValue) {
    ...
    if (doGetValue === void 0) { doGetValue = function (id, isMulti, t, property) {
        if (isMulti) {
            return container_1.ContainerUtil.getAll(id);
        }
        else {
            return container_1.ContainerUtil.get(id);
        }
    }; }
    var type;
    if (index !== undefined) {
...
function applyComponentDecorator(option, target) {
    ...
    if (opt.name) {
        ...
        var _b = opt.tag, tag = _b.tag, value = _b.value;
        whenOn = whenOn.whenTargetTagged(tag, value);
    }
    else if (opt.default) {
        whenOn = whenOn.when(function (request) {
            var targetIsDefault = (request.target) &&
...
var config_protocol_1 = __webpack_require__(/*! ./config-protocol */ "./node_modules/@malagu/core/lib/common/config/config-protocol.js");
var container_1 = __webpack_require__(/*! ../container */ "./node_modules/@malagu/core/lib/common/container/index.js");
var config = {"malagu":{"name":"Malagu Framework","hostDomId":"malagu-root","logger":{"level":"info"},"webpack":{"toES5Plugin":{"include":{"class-transformer":"class-transformer","vscode-jsonrpc":"vscode-jsonrpc"}}},"session":{"autoCommit":true,"maxAge":86400000,"sessionIdKey":"malagu:sessionId","sessionKey":"malagu:session"},"server":{"path":"/","port":3000,"endpoint":"http://localhost:3000"},"trace":{"requestField":"X-Malagu-Trace-ID","responseField":"X-Malagu-Trace-ID"},"web":{"route":{"cacheSize":500}},"client":{"config":{"withCredentials":true}},"mvc":{"path":"/*","defaultViewName":"json"},"mustache":{"cache":false,"baseViewDir":"assets/views"},"rpc":{"path":"api","merge":{"enabled":false,"timerDelay":35,"maxLength":5242880,"maxCount":100}},"core":{"validationPipeOptions":{"detailedOutputDisabled":false,"transformEnabled":true}},"cookies":{"keys":["abcdef"]}},"mode":["local"],"webpackHooks":[],"initHooks":[],"configHooks":[],"buildHooks":[],"deployHooks":[],"serveHooks":[],"cliHooks":[],"targets":["backend"],"server":{"port":3001},"entry":"@malagu/core/lib/common/application/application-entry","devEntry":"@malagu/web/lib/node/application/dev-application-entry","staticModules":[],"modules":["src\\node\\module"],"assets":[]};
var ConfigUtil;
(function (ConfigUtil) {
...
var ExpressionContextProviderImpl = /** @class */ (function () {
    function ExpressionContextProviderImpl(contextInitializers) {
        ...
        this.ctx = config_1.ConfigUtil.getAll();
    }
...
exports.Autorpc = function (target, targetKey, index) {
    ...
    var doInject = function (id, isMulti, t, k, i) {
        ...
        inversify_1.tagged(exports.ID_KEY, id)(t, k, i);
    };
    if (targetKey === undefined) {
        return function (t, tk, i) {
...
(function (RpcOption) {
    ...
    RpcOption.is = is;
})(RpcOption = exports.RpcOption || (exports.RpcOption = {}));
exports.Rpc = function (idOrOption) { return function (target) {
    var id = getRpcOption(idOrOption).id;
    core_1.applyComponentDecorator({ id: id, proxy: true }, target);
    inversify_binding_decorators_1.fluentProvide(handler_1.ConnectionHandler).inSingletonScope().onActivation(function (context) {
        var _a;
    ...
    }).done(true)(handler_1.NoOpConnectionHandler);
}; };
function getRpcOption(idOrOption) {
    if (RpcOption.is(idOrOption)) {
        return __assign({}, idOrOption);
    }
    return { id: idOrOption };
}
exports.getRpcOption = getRpcOption;
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        config = __assign({ url: endpoint, method: web_1.HttpMethod.POST, data: contents.length > 1 ? JSON.stringify(contents) : contents[0], headers: (_a = {},
                                ...
                                _a[node_1.X_REQUESTED_WITH] = node_1.XML_HTTP_REQUEST,
...
(function (RpcUtil) {
    function get(rpcServiceIdentifier) {
        return core_1.ContainerUtil.getNamed(annotation_1.RPC, rpcServiceIdentifier.toString());
    }
    RpcUtil.get = get;
...
exports.default = core_1.autoBind(function (bind) {
    bind(client_1.RestOperations).toFactory(function (ctx) {
...
/***/ "./src/node/controller sync recursive ^\\.\\/.*\\/.*$":
/*!***********************************************!*\
  !*** ./src/node/controller sync ^\.\/.*\/.*$ ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

var map = {
	"./authVetify/auth": "./src/node/controller/authVetify/auth.ts",
	"./authVetify/auth.ts": "./src/node/controller/authVetify/auth.ts",
	"./authVetify/role": "./src/node/controller/authVetify/role.ts",
	"./authVetify/role.ts": "./src/node/controller/authVetify/role.ts",
	"./authVetify/user": "./src/node/controller/authVetify/user.ts",
	"./authVetify/user.ts": "./src/node/controller/authVetify/user.ts"
};
...
webpackContext.id = "./src/node/controller sync recursive ^\\.\\/.*\\/.*$";

/***/ }),

/***/ "./src/node/controller/authVetify/auth.ts":
/*!************************************************!*\
  !*** ./src/node/controller/authVetify/auth.ts ***!
  \************************************************/
/*! no static exports found */
...
var core_1 = __webpack_require__(/*! @malagu/core */ "./node_modules/@malagu/core/lib/common/index.js");
var authService_1 = __webpack_require__(/*! ../../service/authVetify/authService */ "./src/node/service/authVetify/authService.ts");
var authController = /** @class */ (function () {
    function authController() {
    }
    //根据角色id查询其权限信息
    authController.prototype.getAuthByRoleId = function (roleId) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.authService.getAuthByRoleId(roleId)];
    ...
    //查询所有权限
    authController.prototype.getAllAuth = function () {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.authService.getAllAuth()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    __decorate([
        core_1.Autowired(),
        __metadata("design:type", typeof (_a = typeof authService_1.AuthService !== "undefined" && authService_1.AuthService) === "function" ? _a : Object)
    ], authController.prototype, "authService", void 0);
    __decorate([
        node_1.Get('getAuthByRoleId'),
        __param(0, node_1.Query('id')),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Number]),
        __metadata("design:returntype", typeof (_b = typeof Promise !== "undefined" && Promise) === "function" ? _b : Object)
    ], authController.prototype, "getAuthByRoleId", null);
    __decorate([
        node_1.Get('getAllAuth'),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", typeof (_c = typeof Promise !== "undefined" && Promise) === "function" ? _c : Object)
    ], authController.prototype, "getAllAuth", null);
    authController = __decorate([
        node_1.Controller('auth')
    ], authController);
...
/***/ "./src/node/controller/authVetify/role.ts":
/*!************************************************!*\
  !*** ./src/node/controller/authVetify/role.ts ***!
  \************************************************/
/*! no static exports found */
...
var node_1 = __webpack_require__(/*! @malagu/mvc/lib/node */ "./node_modules/@malagu/mvc/lib/node/index.js");
var core_1 = __webpack_require__(/*! @malagu/core */ "./node_modules/@malagu/core/lib/common/index.js");
var roleService_1 = __webpack_require__(/*! ../../service/authVetify/roleService */ "./src/node/service/authVetify/roleService.ts");
var authVetify_1 = __webpack_require__(/*! ../../entity/authVetify */ "./src/node/entity/authVetify/index.ts");
var roleController = /** @class */ (function () {
    function roleController() {
    }
    //查询所有角色并按child列表返回
    roleController.prototype.getAllRole = function () {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    //查询所有角色及其权限
    roleController.prototype.getAllRolesAndAuth = function () {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.roleService.getAllRolesAndAuth()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    //addRole
    roleController.prototype.addRole = function (role) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.roleService.addRole(role)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    //removeRoles
    roleController.prototype.removeRoles = function (category) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.roleService.removeRoles(category)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    //removeRoleAuth
    roleController.prototype.addRoleAuth = function (roleauth) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.roleService.addRoleAuth(roleauth)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    roleController.prototype.removeRoleAuth = function (roleauth) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.roleService.removeRoleAuth(roleauth)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    __decorate([
        core_1.Autowired(),
        __metadata("design:type", typeof (_a = typeof roleService_1.RoleService !== "undefined" && roleService_1.RoleService) === "function" ? _a : Object)
    ], roleController.prototype, "roleService", void 0);
    __decorate([
        node_1.Get('getAllRole'),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", typeof (_b = typeof Promise !== "undefined" && Promise) === "function" ? _b : Object)
    ], roleController.prototype, "getAllRole", null);
    __decorate([
        node_1.Get('getAllRolesAndAuth'),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", typeof (_c = typeof Promise !== "undefined" && Promise) === "function" ? _c : Object)
    ], roleController.prototype, "getAllRolesAndAuth", null);
    __decorate([
        node_1.Post('addRole'),
        __param(0, node_1.Body()),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [typeof (_d = typeof authVetify_1.Role !== "undefined" && authVetify_1.Role) === "function" ? _d : Object]),
        __metadata("design:returntype", typeof (_e = typeof Promise !== "undefined" && Promise) === "function" ? _e : Object)
    ], roleController.prototype, "addRole", null);
    __decorate([
        node_1.Get('removeRoles'),
        __param(0, node_1.Query('category')),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Number]),
        __metadata("design:returntype", typeof (_f = typeof Promise !== "undefined" && Promise) === "function" ? _f : Object)
    ], roleController.prototype, "removeRoles", null);
    __decorate([
        node_1.Post('addRoleAuth'),
        __param(0, node_1.Body()),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [typeof (_g = typeof authVetify_1.Roleauto !== "undefined" && authVetify_1.Roleauto) === "function" ? _g : Object]),
        __metadata("design:returntype", typeof (_h = typeof Promise !== "undefined" && Promise) === "function" ? _h : Object)
    ], roleController.prototype, "addRoleAuth", null);
    __decorate([
        node_1.Post('removeRoleAuth'),
        __param(0, node_1.Body()),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [typeof (_j = typeof authVetify_1.Roleauto !== "undefined" && authVetify_1.Roleauto) === "function" ? _j : Object]),
        __metadata("design:returntype", typeof (_k = typeof Promise !== "undefined" && Promise) === "function" ? _k : Object)
    ], roleController.prototype, "removeRoleAuth", null);
    roleController = __decorate([
        node_1.Controller('role')
    ], roleController);
...
/***/ "./src/node/controller/authVetify/user.ts":
/*!************************************************!*\
  !*** ./src/node/controller/authVetify/user.ts ***!
  \************************************************/
/*! no static exports found */
...
var node_1 = __webpack_require__(/*! @malagu/mvc/lib/node */ "./node_modules/@malagu/mvc/lib/node/index.js");
var core_1 = __webpack_require__(/*! @malagu/core */ "./node_modules/@malagu/core/lib/common/index.js");
var user_1 = __webpack_require__(/*! ../../entity/authVetify/user */ "./src/node/entity/authVetify/user.ts");
var userService_1 = __webpack_require__(/*! ../../service/authVetify/userService */ "./src/node/service/authVetify/userService.ts");
var UserController = /** @class */ (function () {
    ...
    // }
    UserController.prototype.getUserInfo = function (userId) {
        return this.userService.getUserInfo(userId);
    };
    UserController.prototype.getAllUser = function () {
        return this.userService.getAllUser();
    };
    UserController.prototype.getAllUserAndRoles = function () {
        return this.userService.getAllUserAndRoles();
    };
    UserController.prototype.addUserRoles = function (userId, roleId) {
        return this.userService.addUserRoles(userId, roleId);
    };
    UserController.prototype.removeUserRole = function (userId, roleId) {
    ...
    UserController.prototype.getCountByUserName = function (username) {
        return this.userService.getCountByUserName(username);
    };
    //updatePassword
    UserController.prototype.updatePassword = function (user) {
        return this.userService.updatePassword(user);
    };
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m;
    __decorate([
        core_1.Autowired(),
        __metadata("design:type", typeof (_a = typeof userService_1.UserService !== "undefined" && userService_1.UserService) === "function" ? _a : Object)
    ...
    __decorate([
        node_1.Get('getAllUser'),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", typeof (_c = typeof Promise !== "undefined" && Promise) === "function" ? _c : Object)
    ], UserController.prototype, "getAllUser", null);
    __decorate([
        node_1.Get('getAllUserAndRoles'),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", typeof (_d = typeof Promise !== "undefined" && Promise) === "function" ? _d : Object)
    ], UserController.prototype, "getAllUserAndRoles", null);
    __decorate([
        node_1.Get('addUserRoles'),
        __param(0, node_1.Query('userId')), __param(1, node_1.Query('roleId')),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Number, Number]),
        __metadata("design:returntype", typeof (_e = typeof Promise !== "undefined" && Promise) === "function" ? _e : Object)
    ], UserController.prototype, "addUserRoles", null);
    __decorate([
        node_1.Get('removeUserRole'),
        __param(0, node_1.Query('userId')), __param(1, node_1.Query('roleId')),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Number, Number]),
        __metadata("design:returntype", typeof (_f = typeof Promise !== "undefined" && Promise) === "function" ? _f : Object)
    ...
    __decorate([
        node_1.Get('removeUser'),
        __param(0, node_1.Query('userId')),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Number]),
    ...
    __decorate([
        ...
        __param(0, node_1.Body()),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [typeof (_h = typeof user_1.User !== "undefined" && user_1.User) === "function" ? _h : Object]),
        __metadata("design:returntype", typeof (_j = typeof Promise !== "undefined" && Promise) === "function" ? _j : Object)
    ], UserController.prototype, "addUser", null);
    __decorate([
        node_1.Post('getCountByUserName'),
        __param(0, node_1.Body('username')),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [String]),
        __metadata("design:returntype", typeof (_k = typeof Promise !== "undefined" && Promise) === "function" ? _k : Object)
    ], UserController.prototype, "getCountByUserName", null);
    __decorate([
        node_1.Post('updatePassword'),
        __param(0, node_1.Body()),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [typeof (_l = typeof user_1.User !== "undefined" && user_1.User) === "function" ? _l : Object]),
...
/***/ "./src/node/entity/authVetify/authority.ts":
/*!*************************************************!*\
  !*** ./src/node/entity/authVetify/authority.ts ***!
  \*************************************************/
/*! no static exports found */
...
/***/ "./src/node/entity/authVetify/index.ts":
/*!*********************************************!*\
  !*** ./src/node/entity/authVetify/index.ts ***!
  \*********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
__exportStar(__webpack_require__(/*! ./user */ "./src/node/entity/authVetify/user.ts"), exports);
__exportStar(__webpack_require__(/*! ./userrole */ "./src/node/entity/authVetify/userrole.ts"), exports);
__exportStar(__webpack_require__(/*! ./role */ "./src/node/entity/authVetify/role.ts"), exports);
__exportStar(__webpack_require__(/*! ./roleauto */ "./src/node/entity/authVetify/roleauto.ts"), exports);
__exportStar(__webpack_require__(/*! ./authority */ "./src/node/entity/authVetify/authority.ts"), exports);


/***/ }),

/***/ "./src/node/entity/authVetify/role.ts":
/*!********************************************!*\
  !*** ./src/node/entity/authVetify/role.ts ***!
  \********************************************/
/*! no static exports found */
...
/***/ "./src/node/entity/authVetify/roleauto.ts":
/*!************************************************!*\
  !*** ./src/node/entity/authVetify/roleauto.ts ***!
  \************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.Roleauto = void 0;
var Roleauto = /** @class */ (function () {
    function Roleauto() {
    }
    return Roleauto;
}());
exports.Roleauto = Roleauto;


/***/ }),

/***/ "./src/node/entity/authVetify/user.ts":
/*!********************************************!*\
  !*** ./src/node/entity/authVetify/user.ts ***!
  \********************************************/
/*! no static exports found */
...
/***/ "./src/node/entity/authVetify/userrole.ts":
/*!************************************************!*\
  !*** ./src/node/entity/authVetify/userrole.ts ***!
  \************************************************/
/*! no static exports found */
...
/***/ "./src/node/log/listenerMethodTree.ts":
/*!********************************************!*\
  !*** ./src/node/log/listenerMethodTree.ts ***!
  \********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.WriteLogs = void 0;
function WriteLogs(User, methods) {
    var UserPrototype = User.prototype;
    var UserMethods = Object.create(UserPrototype);
    methods.forEach(function (method) {
        var original = UserMethods[method.methodName];
...
/***/ "./src/node/middleware/loginJwt.ts":
/*!*****************************************!*\
  !*** ./src/node/middleware/loginJwt.ts ***!
  \*****************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.LoginJwtMiddleware = void 0;
var core_1 = __webpack_require__(/*! @malagu/core */ "./node_modules/@malagu/core/lib/common/index.js");
var node_1 = __webpack_require__(/*! @malagu/web/lib/node */ "./node_modules/@malagu/web/lib/node/index.js");
var rpc_1 = __webpack_require__(/*! @malagu/rpc */ "./node_modules/@malagu/rpc/lib/common/index.js");
var LoginJwtMiddleware = /** @class */ (function () {
    function LoginJwtMiddleware() {
        this.priority = 1;
    }
    LoginJwtMiddleware.prototype.handle = function (ctx, next) {
        return __awaiter(this, void 0, Promise, function () {
            var request, token, flag;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        request = node_1.Context.getRequest();
                        ...
                        if (!(request.path === '/user/login')) return [3 /*break*/, 2];
                        return [4 /*yield*/, next()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                    case 2: return [4 /*yield*/, this.UserLogin.vetifyToken(token)];
                    case 3:
                        flag = _a.sent();
    ...
    __decorate([
        ...
        __metadata("design:type", Object)
    ], LoginJwtMiddleware.prototype, "UserLogin", void 0);
    LoginJwtMiddleware = __decorate([
        core_1.Component(node_1.Middleware)
    ], LoginJwtMiddleware);
    return LoginJwtMiddleware;
}());
exports.LoginJwtMiddleware = LoginJwtMiddleware;
...
Object.defineProperty(exports, "__esModule", { value: true });
__webpack_require__(/*! ./middleware/loginJwt */ "./src/node/middleware/loginJwt.ts");
__webpack_require__(/*! ./controller/authVetify/user */ "./src/node/controller/authVetify/user.ts");
__webpack_require__(/*! ./controller/authVetify/role */ "./src/node/controller/authVetify/role.ts");
__webpack_require__(/*! ./controller/authVetify/auth */ "./src/node/controller/authVetify/auth.ts");
var core_1 = __webpack_require__(/*! @malagu/core */ "./node_modules/@malagu/core/lib/common/index.js");
var logs_1 = __webpack_require__(/*! ./log/logs */ "./src/node/log/logs.ts");
var listenerMethodTree_1 = __webpack_require__(/*! ./log/listenerMethodTree */ "./src/node/log/listenerMethodTree.ts");
// import {UserController} from "./controller/authVetify/user";
//监听controller，写入数据流数据库
listenerMethodTree_1.methodThree.forEach(function (model) {
    model.router.forEach(function (controller) {
        var _a = __webpack_require__("./src/node/controller sync recursive ^\\.\\/.*\\/.*$")(`./${model.modelName}/${controller.routerTs}`), _b = controller.routerName, routername = _a[_b];
        logs_1.WriteLogs(routername, controller.method);
    });
});
exports.default = core_1.autoBind();
...
/***/ "./src/node/service/authVetify/authService.ts":
/*!****************************************************!*\
  !*** ./src/node/service/authVetify/authService.ts ***!
  \****************************************************/
/*! no static exports found */
...
var AuthService = /** @class */ (function () {
    ...
    // }
    AuthService.prototype.getAuthByRoleId = function (roleId) {
        return __awaiter(this, void 0, Promise, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, responseData_1.responseData(0, data, '获取成功')];
                }
            });
        });
    };
    AuthService.prototype.getAllAuth = function () {
        return __awaiter(this, void 0, Promise, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    __decorate([
        rpc_1.Autorpc('https://1476306111676342.cn-shanghai.fc.aliyuncs.com/2016-08-15/proxy/malagu.test/auth-vetify/api/AuthInterfaceService'),
        __metadata("design:type", Object)
    ], AuthService.prototype, "authService", void 0);
...
/***/ "./src/node/service/authVetify/roleService.ts":
/*!****************************************************!*\
  !*** ./src/node/service/authVetify/roleService.ts ***!
  \****************************************************/
/*! no static exports found */
...
var RoleService = /** @class */ (function () {
    ...
    RoleService.prototype.getAllRolesAndAuth = function () {
        return __awaiter(this, void 0, Promise, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    RoleService.prototype.removeRoles = function (category) {
        return __awaiter(this, void 0, Promise, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = _a.sent();
                        if (data === '删除成功') {
                            return [2 /*return*/, responseData_1.responseData(0, data, '删除成功')];
                        }
                        else {
                            return [2 /*return*/, responseData_1.responseData(100, data, data)];
                        }
                        return [2 /*return*/];
                }
            });
    ...
    RoleService.prototype.addRoleAuth = function (roleauth) {
        return __awaiter(this, void 0, Promise, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, responseData_1.responseData(0, data, '添加成功')];
                }
            });
        });
    };
    RoleService.prototype.removeRoleAuth = function (roleauth) {
        return __awaiter(this, void 0, Promise, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    __decorate([
        rpc_1.Autorpc('https://1476306111676342.cn-shanghai.fc.aliyuncs.com/2016-08-15/proxy/malagu.test/auth-vetify/api/RoleInterfaceService'),
        __metadata("design:type", Object)
    ], RoleService.prototype, "roleService", void 0);
...
/***/ "./src/node/service/authVetify/userService.ts":
/*!****************************************************!*\
  !*** ./src/node/service/authVetify/userService.ts ***!
  \****************************************************/
/*! no static exports found */
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getUserInfo = function (userId) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.UserServer.getUserInfo(userId)];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, responseData_1.responseData(0, data, '查询成功')];
                }
            });
        });
    };
    UserService.prototype.getAllUser = function () {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.UserServer.getAllUser()];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, responseData_1.responseData(0, data, '查询成功')];
                }
    ...
    UserService.prototype.getAllUserAndRoles = function () {
        return __awaiter(this, void 0, Promise, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.UserServer.getAllUserAndRoles()];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, responseData_1.responseData(0, data, '查询成功')];
                }
    ...
    UserService.prototype.addUserRoles = function (userId, roleId) {
        return __awaiter(this, void 0, Promise, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.UserServer.addUserRoles(userId, roleId)];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, responseData_1.responseData(0, data, '添加成功')];
                }
    ...
    UserService.prototype.removeUserRole = function (userId, roleId) {
        return __awaiter(this, void 0, Promise, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.UserServer.removeUserRole(userId, roleId)];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, responseData_1.responseData(0, data, '删除成功')];
                }
    ...
    UserService.prototype.removeUser = function (userId) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.UserServer.removeUser(userId)];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, responseData_1.responseData(0, data, '删除成功')];
                }
    ...
    UserService.prototype.addUser = function (user) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.UserServer.addUser(user)];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, responseData_1.responseData(0, data, '添加成功')];
                }
    ...
    UserService.prototype.getCountByUserName = function (username) {
        return __awaiter(this, void 0, Promise, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.UserServer.getCountByUserName(username)];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, responseData_1.responseData(0, data, '查询成功')];
                }
    ...
    UserService.prototype.updatePassword = function (user) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.UserServer.updatePassword(user)];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, responseData_1.responseData(0, data, '更新成功')];
                }
            });
        });
    };
    __decorate([
        rpc_1.Autorpc('https://1476306111676342.cn-shanghai.fc.aliyuncs.com/2016-08-15/proxy/malagu.test/userlogin/api/UserLogin'),
        __metadata("design:type", Object)
    ], UserService.prototype, "UserLogin", void 0);
    __decorate([
        rpc_1.Autorpc('https://1476306111676342.cn-shanghai.fc.aliyuncs.com/2016-08-15/proxy/malagu.test/auth-vetify/api/UserInterfaceServive'),
        __metadata("design:type", Object)
